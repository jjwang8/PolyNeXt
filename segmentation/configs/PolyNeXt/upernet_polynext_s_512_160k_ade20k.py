...
# CPolyNeXt-S: init_channels=72, channel multipliers = {1x, 2x, 4x, 6x}
...
model = dict(
    ...
    backbone=dict(
        ...
        drop_path_rate=0.3,
        norm_eval=False,
        # ImageNet-1K pretrained CPolyNeXt-S classification checkpoint.
        # Download from https://huggingface.co/JJWCactus/PolyNeXt
        pretrained='path/to/cpolynext_s.pt',
    ),
    decode_head=dict(
        type='UPerHead',
